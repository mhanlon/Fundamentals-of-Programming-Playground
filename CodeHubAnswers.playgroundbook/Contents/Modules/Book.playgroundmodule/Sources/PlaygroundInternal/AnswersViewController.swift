...
class AnswersViewController: UITableViewController, PlaygroundLiveViewMessageHandler, InputCellDelegate, UIKeyInput {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(CheckboxInputCell.self, forCellReuseIdentifier: CheckboxInputCell.reuseIdentifier)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if item.isUserEntered {
            ...
            switch valueType {
            case .bool:
                cellReuseIdentifier = CheckboxInputCell.reuseIdentifier
            case .number, .decimal:
